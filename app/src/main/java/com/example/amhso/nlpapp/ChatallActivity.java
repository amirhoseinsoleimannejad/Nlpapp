        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                for (int i = 0; i < contacts.length(); i++) {
                    ...
                    if(id_user.equals(sharedpreferences.getString(G.id_sick ,"-1"))){
        ...
        protected String doInBackground(String... params) {
            ...
            try {
               ...
               SharedPreferences sharedpreferences = getSharedPreferences(G.MyPREFERENCES, Context.MODE_PRIVATE);
                ...
                nameValuePairs.add(new BasicNameValuePair("id_user", sharedpreferences.getString(G.id_sick ,"-1").trim()));
