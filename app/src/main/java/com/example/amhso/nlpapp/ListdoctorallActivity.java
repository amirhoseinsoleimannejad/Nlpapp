...
public class ListdoctorallActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_listdoctorall);
        ...
        new sendhttp(G.FetchlistDoctorAll,"aaa",Code).execute();
